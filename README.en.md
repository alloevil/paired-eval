...
<p align="center"><em>Evaluate models, agents and harnesses: verify programmatically whatever can be verified, hand the rest to a rubric — and make every comparison a statistically honest paired one.</em></p>
<p align="center">
...
<p align="center"><a href="https://alloevil.github.io/paired-eval/">Website</a> · <a href="README.md">中文</a> · <a href="docs/README.md">Docs</a> · <a href="CHANGELOG.md">Changelog</a></p>
...
- **Status**: 0.2.0, single author, API may change. Reports in English and Chinese (`set_language`); code comments and built-in tasks are Chinese.
